...
namespace OpenKh.Kh2.Messages.Internals
{
    internal class GreekSystemDecode : IMessageDecode
    {
        ...
        public static readonly Dictionary<byte, BaseCmdModel> _table = new Dictionary<byte, BaseCmdModel>
        {
            ...
            [0x7f] = new TextCmdModel('A'), //Replaced to prevent conflicts
            [0x80] = new TextCmdModel('B'),
            [0x81] = new TextCmdModel('C'),
            ...
            [0xdd] = new TextCmdModel('y'),
            [0xde] = new TextCmdModel('b'),
            [0xdf] = new TextCmdModel('l'),
